...
/* ───────────── 기본값 ───────────── */
const COMMON0 = { ret: 7, expg: 3, infl: 2.5, swr: 4, salecost: 0.5, alloc: { rule: "g110", fixed: 70, safe: 3, trough: 30, end: 65 } };
const ME0 = { name: "나", age: 34, asset: 12000, income: 7500, growth: 3, retireAge: 55, life: 100, irr: 800, pensionAge: 65, pension: 1200, exp: { now: 250, lean: 160, std: 250, fat: 480 } };
const SPOUSE0 = { name: "배우자", age: 32, asset: 7000, income: 5500, growth: 3, retireAge: 55, life: 100, irr: 600, pensionAge: 65, pension: 900, exp: { now: 230, lean: 150, std: 230, fat: 420 } };
const SOLO0 = { ...ME0, income: 6500, exp: { now: 280, lean: 190, std: 280, fat: 520 } };
const ADV0 = {
  pension: { on: false },
...
const yAxisFmt = (v) => (v >= 10000 ? (v / 10000).toFixed(0) + "억" : Math.round(v / 1000) + "천");

/* ───────────── 자산배분(글라이드 패스) ───────────── */
const clamp = (x, a, b) => Math.max(a, Math.min(b, x));
function equityWeight(alloc, age, startAge, retireAge) {
...
/* ───────────── 엔진 ───────────── */
function useEngine(common, people, adv) {
  return useMemo(() => {
